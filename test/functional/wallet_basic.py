...
class WalletTest(CicoinTestFramework):
    ...
    def run_test(self):
        ...
        # This will raise an exception for attempting to get the private key of an invalid Cicoin address
        assert_raises_rpc_error(-5, "Invalid Cicoin address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Cicoin address
        assert_raises_rpc_error(-5, "Invalid Cicoin address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Cicoin address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/cicoin/cicoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
