...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.cicoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.cicoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.cicoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.cicoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.cicoin.sprovoost.nl"); // Sjors Provoost
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cicoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.cicoin.sprovoost.nl");
