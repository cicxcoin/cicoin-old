    ...
    platformStyle(_platformStyle)
{
    ...
    // normal cicoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying cicoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CicoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
